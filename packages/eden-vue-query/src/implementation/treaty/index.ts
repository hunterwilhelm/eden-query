...
import type { EdenTreatyVueQueryCreateQueries } from './create-queries'
 ...
 */
export type EdenTreatyVueQuery<
  TElysia extends AnyElysia,
  TSSRContext,
> = EdenTreatyVueQueryBase<TElysia, TSSRContext> & EdenTreatyVueQueryHooks<TElysia>
...
export interface EdenTreatyVueQueryBase<TElysia extends AnyElysia, TSSRContext> {
   ...
   */
  getUtils(): EdenTreatyVueQueryUtils<TElysia, TSSRContext>
   ...
   * @see https://trpc.io/docs/v11/client/react/useUtils
   */
  getContext(): EdenTreatyVueQueryUtils<TElysia, TSSRContext>
  ...
  /**
   * Wraps the `create-queries` vue-query hook in a type-safe proxy.
   */
  createQueries: EdenTreatyVueQueryCreateQueries<TElysia>
...
/**
 * RPC proxy derived from {@link AnyElysia._routes} that connects vue-query with an Elysia.js API.
 */
 ...
 * Leaves are objects with vue-query hooks related to the HTTP method.
 *
...
/**
 * vue-query hooks for "queries". e.g. routes with a "GET" endpoint.
 */
...
/**
 * @todo: vue-query hooks for "subscriptions". e.g. Basically routes that support "CONNECT" or "SUBSCRIBE" requests.
 *
...
export function getQueryKey<TSchema extends Record<string, any>>(
  route: EdenTreatyVueQueryHooksProxy<TSchema>,
