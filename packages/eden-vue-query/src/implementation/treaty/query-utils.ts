...
export type EdenTreatyQueryUtils<TElysia extends AnyElysia> = ProtectedIntersection<
  EdenTreatyQueryContextProps<TElysia>,
    ...
    options:
      ...
      | ((args: {
          canonicalMutationFn: NonNullable<
            UnwrapRef<EdenUseMutationOptions<TBody, TError, TOutput>>['mutationFn']
          >
        }) => EdenUseMutationOptions<TBody, TError, TOutput>),
  ): void
...
export function createEdenTreatyQueryUtils<TRouter extends AnyElysia>(
 ...
 */
export function createEdenTreatyQueryUtilsProxy<TRouter extends AnyElysia>(
  context: EdenContextState<TRouter>,
  config?: EdenQueryConfig<TRouter>,
