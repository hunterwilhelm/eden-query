...
export type EdenTreatyVueQueryUtils<TElysia extends AnyElysia, TSSRContext> = ProtectedIntersection<
  DecoratedEdenTreatyVueQueryContextProps<TElysia, TSSRContext>,
  EdenTreatyVueQueryUtilsProxy<TElysia['_routes']>
>

export type DecoratedEdenTreatyVueQueryContextProps<TElysia extends AnyElysia, TSSRContext> = Omit<
...
export type EdenTreatyVueQueryContextProps<
...
export type EdenTreatyVueQueryUtilsProxy<
  TSchema extends Record<string, any>,
  TPath extends any[] = [],
  TRouteParams = ExtractEdenTreatyRouteParams<TSchema>,
> = EdenTreatyQueryUtilsUniversalUtils & {
  [K in keyof TSchema]: TSchema[K] extends RouteSchema
    ? EdenTreatyVueQueryUtilsMapping<TSchema[K], TPath, K>
    : EdenTreatyVueQueryUtilsProxy<TSchema[K], [...TPath, K]>
} & ({} extends TRouteParams
    ? {}
    : (
        params: ExtractEdenTreatyRouteParamsInput<TRouteParams>,
      ) => EdenTreatyVueQueryUtilsProxy<TSchema[Extract<keyof TRouteParams, keyof TSchema>], TPath>)

type EdenTreatyVueQueryUtilsMapping<
...
): EdenTreatyVueQueryUtils<TRouter, TSSRContext> {
