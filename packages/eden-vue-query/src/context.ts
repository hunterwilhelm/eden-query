...
export type EdenPluginProps<TRouter extends AnyElysia, TSSRContext> = EdenContextProps<
  TRouter,
  TSSRContext
>
export type EdenPlugin<TRouter extends AnyElysia, TSSRContext> = (
  props: EdenPluginProps<TRouter, TSSRContext>,
) => Plugin
...
export type EdenContextState<TRouter extends AnyElysia, _TSSRContext = undefined> = Required<
  EdenContextProps<TRouter, _TSSRContext>
> &
...
export function createUtilityFunctions<T extends AnyElysia>(
  ...
  return {
    ...
    invalidateQueries: async (queryKey, filters, options) => {
      console.log('invalidateQueries', queryKey, filters, options)
